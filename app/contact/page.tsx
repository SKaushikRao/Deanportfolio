    ...
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 lg:ml-80">
        <div className="max-w-5xl mx-auto px-6 py-12 lg:px-12 lg:py-16">
          <div className="mb-12">
            <h1 className="text-6xl font-bold mb-4 text-foreground">Contact</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-10">
                ...
                <a href="tel:+918890306647" className="text-lg text-muted-foreground hover:text-primary transition-colors">
                  +91-8890306647
                </a>
              </CardContent>
            </Card>
