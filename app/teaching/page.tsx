    ...
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 lg:ml-80">
        <div className="max-w-5xl mx-auto px-6 py-12 lg:px-12 lg:py-16">
          <div className="mb-12">
            <h1 className="text-6xl font-bold mb-4 text-foreground">Teaching Experience</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-10 text-center">
                ...
                <p className="text-lg text-foreground font-semibold mt-2">U.G. Level</p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-10 text-center">
                ...
                <p className="text-lg text-muted-foreground">Years</p>
                <p className="text-lg text-foreground font-semibold mt-2">P.G. Level</p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-10 text-center">
                <div className="text-6xl font-bold text-primary mb-3">20</div>
                <p className="text-lg text-muted-foreground">Years</p>
                <p className="text-lg text-foreground font-semibold mt-2">Research</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="space-y-6">
            <Card>
              <CardContent className="p-10">
                <h2 className="text-3xl font-bold mb-6 text-foreground">Research Guidance</h2>
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <div className="text-4xl font-bold text-primary">10</div>
                    <p className="text-lg text-foreground">P.G. theses guided</p>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="text-4xl font-bold text-primary">8</div>
                    <p className="text-lg text-foreground">Ph.D. thesis guiding (3 completed)</p>
                  </div>
                  <div className="mt-6 space-y-2 text-lg text-foreground">
            ...
            <Card>
              <CardContent className="p-10">
                <h2 className="text-3xl font-bold mb-6 text-foreground">Academic Leadership</h2>
