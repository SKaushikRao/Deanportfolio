    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ImageGallery.useEffect": ()=>{
            ...
            const loadImagesFromFolder = {
                "ImageGallery.useEffect.loadImagesFromFolder": async ()=>{
                    try {
                        ...
                        for(let i = 1; i <= 50; i++){
                            for (const ext of imageExtensions){
                                ...
                                const img = new Image();
                                img.onload = ({
                                    "ImageGallery.useEffect.loadImagesFromFolder": ()=>{
                                        // Only add if image loads successfully
                                        if (!possibleImages.some({
                                            "ImageGallery.useEffect.loadImagesFromFolder": (item)=>item.image === imagePath
                                        }["ImageGallery.useEffect.loadImagesFromFolder"])) {
                                            possibleImages.push({
                                                image: imagePath,
                                                text: `${title} ${i}`
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    galleryItems.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ImageGallery, "KY/m74tL0AjnE8Z6OzdiMKyBbOM=");
_c = ImageGallery;
var _c;
...
//# sourceMappingURL=_d92ac480._.js.map